...
class TestUtil(unittest.TestCase):
    ...
    def test_read_file(self):
        ...
        with self.assertRaises(Exception):
            ...
            utils.read_file('test_cases/incorrect_test_read_file1.csv', ['student_id', 'student_name'])
    ...
    def test_csv2json(self):
        ...
        for student in utils.csv2json(correct_case)['students']:
            ...
            for course in student['courses']:
                ...
                self.assertLessEqual(course['courseAverage'], 100)
        # incorrect values in dataframe
        ...
        with self.assertRaises(Exception):
            for student in utils.csv2json(misshaped_case)['students']:
                self.assertLessEqual(student['totalAverage'], 100)
                for course in student['courses']:
                    self.assertLessEqual(course['courseAverage'], 100)
